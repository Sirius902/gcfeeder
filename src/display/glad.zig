...
const glGetUniformLocation = ?fn (program: GLuint, name: *const GLchar) callconv(.C) GLint;
...
const glUniform3fv = ?fn (location: GLint, count: GLsizei, value: *const GLfloat) callconv(.C) void;
